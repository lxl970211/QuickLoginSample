...
import com.energysh.quicklogin.util.MD5STo16Byte;
import com.energysh.quicklogin.util.RSAUtils;
...
public class CMCCParamterBean {
    ...
    public String generateSignByRSA() {
        ...
        return RSAUtils.generalSign(str, AppConstant.PRIVATE_KEY);
    }
